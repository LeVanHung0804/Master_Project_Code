...
def main():
    ...
    # test_data = MyDataset(test_data[0], test_data[1], test_data[2], max_person_info, max_output)
    #
    # # dataloader
    ...
    load_model(model,save_weights_path)
    ...
    plot_pre_out_comparision(predict,output,max_output)
